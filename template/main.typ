...
= Quellen & Literaturkritik
#linebreak()

#align(center)[*Mit welchen Quellen habe ich gearbeitet?*]
Es soll anhand von drei Beispielen dargelegt werden, welche Quellen und Medien
für die Bearbeitung der Untersuchungsfrage verwendet wurden und wie hilfreich
diese waren. Es bietet sich an, positive und negative Beispiele hier zu
beschreiben. Dabei soll kritisch dargelegt werden, in welcher Art und Weise die
Medien/Quellen benutzt wurden, wie sie gegebenenfalls mit KI-Tools
zugänglicher gemacht wurden, in welcher Hinsicht sie geeignet oder ungeeignet
waren und welche Schwierigkeiten oder Hürden bei der Arbeit mit dem Medium
aufgetreten sind. Kriterien zur kritischen Reflexion könnten beispielsweise
folgende sein:

Beispielquellen zum Eintragen in die Bibliografie sind
#cite(<beispiel-journal>, supplement: "Beispiel Journal"),
#cite(<beispiel-zeitung>, supplement: "Beispiel Zeitung"),
#cite(<beispiel-webseite>, supplement: "Beispiel Webseite"),
#cite(<beispiel-sendung>, supplement: "Beispiel Sendung"),
#cite(<beispiel-film>, supplement: "Beispiel Film"),
#cite(<beispiel-ki-tool>, supplement: "Beispiel KI-Tool"),
#cite(<beispiel-buch>, supplement: "Beispiel Buch") und
#cite(<beispiel-sonstiges>, supplement: "Beispiel Sonstiges").

- *Zugänglichkeit:* Gibt es Möglichkeiten, einfach, schnell und kostenfrei auf
	die Quelle zuzugreifen?
- *Struktur:* Unterliegt das Medium einer nachvollziehbaren Struktur, die die
	Orientierung oder Suche im Medium erleichtert?
- *Fachlichkeit:* Ist das Medium fachlich tiefgehend genug für die Erarbeitung,
	bzw. ist es vielleicht auf einem so hohen fachlichen Niveau, dass das
	Eindringen in die Materie nicht einfach ist?
- *Aussagekraft/Transparenz:* Ist erkennbar, wer das Medium erstellt hat und
	welche Intention es besitzt? Ist das Medium eine vertrauenswürdige Quelle?
	Woran kann das im speziellen Fall festgemacht werden?
- *Sprache:* Ist die Sprache des Mediums gut zugänglich, aber doch
	fachsprachlich präzise genug, um das Medium gut nutzen zu können?
- *Autor\*in:* Welchen fachlichen Hintergrund hat der/die Autor\*in? Sind sie
	auf wissenschaftlicher Ebene mit dem Thema befasst? Haben sie weitere Arbeiten
	zur Thematik erstellt? Werden ihre Arbeiten in der Fachwelt diskutiert?

_(Getrennte Darstellung)_
#linebreak()
#linebreak()
